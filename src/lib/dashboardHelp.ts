...
export const INSTRUCTOR_GROUPS: SidebarGroupDef[] = [
  GROUP('content', 'المحتوى التعليمي', 'Teaching Content', 'إنشاء وإدارة الدورات والواجبات وبنك الأسئلة.', 'Create and manage courses, assignments and the question bank.', ['courses', 'communities', 'assignments', 'question-bank', 'assigned-requests']),
