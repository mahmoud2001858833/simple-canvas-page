...
export const DashboardSidebar = ({ activeTab, onTabChange, isOpen, onToggle, userRole, ...props }: SidebarProps) => {
  ...
  const adminTabs = [
    ...
    { id: 'teachers-onboarding', label: { ar: 'انضمام المعلمين والمصادر', en: 'Teachers Onboarding' }, icon: UserCheck, onboardingId: null, showBadge: false, isAction: false },
    ...
    { id: 'communities', label: { ar: 'مجتمعات وقروبات الدورات 💬', en: 'Course Communities' }, icon: MessagesSquare, onboardingId: null, showBadge: false, isAction: false },
    ...
    { id: 'payout-negotiations', label: { ar: 'طرق الدفع والتفاوض', en: 'Payout Negotiations' }, icon: Landmark, onboardingId: null, showBadge: false, isAction: false },
